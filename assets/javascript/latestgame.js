...
function startGame() { /* this is what happens when user clicks start game button */
	...
	var printGuessesLeft = document.getElementById("guessesLeft"); 
...
document.onkeyup = function(event) { /*when user clicks the start button */
	...
	if (guessesLeft == 0) {
	    ...
	    var printGuessesLeft = document.getElementById("guessesLeft"); 
	    printGuessesLeft.innerHTML = "NO MORE GUESSES LEFT!!! YOU LOST!!!";	            /*  print userGuess on page  */				
		losses++;
